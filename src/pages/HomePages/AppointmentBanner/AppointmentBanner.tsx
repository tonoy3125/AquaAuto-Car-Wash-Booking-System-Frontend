    ...
    <div className="w-full pb-56 relative">
      <div className="border relative">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center ">
          <h3 className="font-poppins font-bold text-3xl md:text-4xl text-white text-center mb-1">
            Schedule Your appointment today
          </h3>
          <p className="font-poppins semi-sm:text-sm md:text-base text-white text-center mb-4">
      ...
      <div className="absolute right-0 bottom-28">
        <img
          className="hidden md:block md:w-96 lg:w-full"
